...
Se han combinado dos fuentes de datos principales: \texttt{db\_orig.csv} y \texttt{db\_modified\_descriptions.csv}, creando un corpus robusto con el doble de ejemplos por categoría. El preprocesamiento incluye:
\begin{itemize}
