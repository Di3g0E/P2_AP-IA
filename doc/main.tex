...
\begin{titlepage}
    ...
    {\Huge \textbf{Práctica 2: Clasificación de Transacciones mediante PLN} \par}
    \vspace{1.5cm}
    ...
    {\large Sofía Contreras (12345678N) \par}
...
% --- Página 5: Inicio Contenido (Interna 3) ---
\pagestyle{plain}
